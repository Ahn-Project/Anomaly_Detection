...
root_dir = './data/DAGM 2007 Dataset/normal_and_abnormal/'
...
if __name__ == '__main__':
      ...
      torch.save(model_ft.state_dict(), wts_save_path+'weights_4classes_{} (epochs={}).pth'.format(version, num_epochs))
      ...
      fvs_save_path = './fvs/'
      dir_path = fvs_save_path + '4classes_classifier_(using_Normal_and_Abnormal)_{}'.format(version)
      if not os.path.isdir(dir_path):
          os.mkdir(dir_path)

      np.save(os.path.join(dir_path, 'fvs_DAGM2007_normal_and_abnormal_{}'.format(version)), fvs_array)
      np.save(os.path.join(dir_path, 'label_DAGM2007_normal_and_abnormal_{}'.format(version)), label_array)
